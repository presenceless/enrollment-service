...
public class FileServiceImpl implements FileService {
     ...
     */
    @Override
    public Map<String, String> uploadFile(MultipartFile file, Long id, String sub) throws IOException {
        String fileName = Objects.requireNonNull(file.getOriginalFilename()).replace(" ", "_");
        BlobId blobId = BlobId.of(bucketName, sub + id.toString() + "/" + fileName);
        ...
        return Map.of(
                "mediaLink", blob.signUrl(365, TimeUnit.DAYS).toString(),
